        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodRecords_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodRecordId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodImages_FoodRecords_FoodRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodImages_FoodRecordId",
                table: "FoodImages",
                column: "FoodRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodRecords_CategoryId",
                table: "FoodRecords",
                column: "CategoryId");
